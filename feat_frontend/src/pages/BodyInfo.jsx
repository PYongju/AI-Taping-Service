		...
		<div className="page">
			<div className="topbar">
				<button
					className="back"
					onClick={() =>
						tab > 1 ? setTab(tab - 1) : navigate("/consent")
					}
				>
						...
						<div className="photo-guide-grid">
							<div className="guide-example good">
								...
								>
									...
									/>
									<path
										d="M14 34 L30 28 L46 34 L40 66 L36 98 L30 98 L26 66 L22 98 L14 98 L20 66 Z"
										stroke="#16a34a"
										strokeWidth="2"
							...
							<div className="guide-example bad">
								...
								>
									...
									/>
									<path
										d="M20 34 L36 30 L50 38 L48 70 L50 98 L44 98 L38 70 L32 92 L26 92 L30 68 Z"
										stroke="#ef4444"
										strokeWidth="2"
										strokeLinejoin="round"
									/>
				...
				{tab === 3 && (
					<div>
						...
						<div
							...
							onClick={() =>
								!photoUploaded && setPhotoUploaded(true)
							}
						>
							{!photoUploaded ? (
								<div
								...
								<>
									<div
										style={{
											...
											inset: 0,
											background:
												"linear-gradient(135deg,#fde68a 0%,#fbbf24 45%,#fb923c 100%)",
											display: "flex",
											alignItems: "center",
